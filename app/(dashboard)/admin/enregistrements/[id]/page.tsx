...
import {
  ...
  DescriptionOutlined, DownloadOutlined, WarningAmberOutlined,
  VerifiedOutlined, BusinessOutlined
...
export default function AdminEnregistrementDetailPage() {
  ...
  return (
    <Box>
      ...
      {/* ── Header — lecture seule, aucun bouton d'action ── */}
          ...
          <Card>
            <CardContent>
              ...
              <InfoRow
                ...
                value={
                  enreg.agence_nom
                    ? `${enreg.agence_nom}${enreg.agence_code ? ` (${enreg.agence_code})` : ''}`
                    : '—'
                }
              />
              <Divider />
                ...
                <>
                  ...
                  <InfoRow
                    ...
                    value={`${enreg.verifie_par_nom}${enreg.verifie_le
                      ? ' · ' + new Date(enreg.verifie_le).toLocaleString('fr-FR')
                      : ''}`}
                  />
                </>
              )}
