...
//LA MODIFICATIONS DU 10/07/2023
...
export default function NouveauClientPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Données Client (et numéros/dates de pièces)
    Object.entries(form).forEach(([key, value]) => {
      // Les dates d'expiration vides ne sont pas envoyées, pour éviter
      // d'écraser avec une chaîne vide côté backend
